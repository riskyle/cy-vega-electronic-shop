                        ...
                        <div class="card-body">
                            <form action="functions/authcode.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="password" class="form-control" placeholder="&#xf023; Enter your password" style="font-family:Arial, FontAwesome" title="Password must be 8 characters including 1 uppercase letter, 1 lowercase letter and numeric characters" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}" id="exampleInputPassword1" required="true">
                                ...
                                <hr>
                                <center> <a>If you have an Account</a> </center>
                                <center> <button type="button" name="login_btn" class="btn btn-outline-success" onclick="window.location.href='login.php'">Login</button></center>
                            </form>
