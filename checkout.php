    ...
    <div class="container">
        <div class="card">
            <div class="card-body shadow">
                <form action="<?= sanitize("functions/placeorder.php") ?>" method="POST">
                    <div class="row">
                        <div class="col-md-7">
                            <h5>Your Details</h5>
                            <hr>
                        ...
                        <div class="col-md-5">
                            ...
                            ?>
                                <div class="mb-1 border">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-3">
                                            <h5>x<?= sanitize($citem['prod_qty']); ?></h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            ?>
                            <hr>
                            <h5>Total Price : <span class="float-end fw-bold">₱<?= sanitize($totalPrice) ?>.000</span></h5>
                            <div class="">
                                <input type="hidden" name="payment_mode" value="COD">
                                <button type="submit" name="placeorderbtn" class="btn btn-outline-primary w-100">Pay Via | COD</button>

                                <input type="hidden" name="payment_mode" value="Gcash">
                                <button type="submit" name="placeorderbtn" class="btn btn-outline-primary w-100">Pay Via | Gcash</button>
                            </div>
                        </div>
                    </div>
                </form>
